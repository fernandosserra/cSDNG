...
int innPtBR(){
	...
	case 3:
		...
		printf("\n\t\t /'Ao entregar algumas moedas para o homem, ele surrurra em seu ouvido:");
		printf("\n\t\t O velho cemitério tem alguns problemas com a gestao principal.\n\t\t Se eu fosse voce, investigaria por la");
